...
public class Household extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mItemlist=(RecyclerView)findViewById(R.id.itemlisthousehold);
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child(userId).child("Household").child("item");
    ...
    public void AddItems(View view){
        startActivity(new Intent(Household.this,Addingitemshousehold.class));
    ...
    public void logout(View view)
    {
        ...
        finish();
        Toast.makeText(Household.this, "You are logged out", Toast.LENGTH_SHORT).show();
    }
