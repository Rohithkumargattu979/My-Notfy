...
public class Addingitemsoffice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addingitemsoffice);
        mAuth = FirebaseAuth.getInstance();
        userId = mAuth.getCurrentUser().getUid();
        Addtodatabase = (Button) findViewById(R.id.addtodatabaseoffice);
        Itemname = (EditText) findViewById(R.id.itemnameoffice);
        Itemnumber = (EditText) findViewById(R.id.itemnumberoffice);
        mDatabase = FirebaseDatabase.getInstance().getReference().child(userId).child("Office").child("item");
        mProgress = new ProgressDialog(this);
        Itemdescription = (EditText) findViewById(R.id.itemdescriptionoffice);
        mSelectimage = (ImageButton) findViewById(R.id.imageselectoffice);
