...
public class OtpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.otpphn_activity);
    ...
    private void startTimer(final long finish, final long tick) {
        ...
        countDownTimer = new CountDownTimer(finish, tick) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(OtpActivity.this, "Finish",
                        Toast.LENGTH_LONG).show();
    ...
    private void firebaseLogin() {
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(@NonNull PhoneAuthCredential phoneAuthCredential) {
                Toast.makeText(OtpActivity.this,"Verification Completed",
                        Toast.LENGTH_LONG).show();
            }
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                Toast.makeText(OtpActivity.this, "Code Sent",
                        Toast.LENGTH_LONG).show();
